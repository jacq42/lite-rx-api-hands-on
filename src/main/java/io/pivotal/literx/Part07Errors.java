...
//========================================================================================
	...
	Flux<User> capitalizeMany(Flux<User> flux) {
		//return capitalizeManyWithMap(flux);
		return capitalizeManyWithHandle(flux);
	}

	private Flux<User> capitalizeManyWithHandle(final Flux<User> flux) {
		return flux.handle((user, sink) -> {
			try {
	...
	private Flux<User> capitalizeManyWithMap(final Flux<User> flux) {
